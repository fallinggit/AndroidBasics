...
public class MyListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 给控件赋值
        holder.titleTV.setText("这是标题");
        holder.timeTV.setText("2088-08-08");
        holder.contentTV.setText("这是美好的一天");
        Glide.with(mContext).load("https://dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/img/logo/logo_white-d0c9fe2af5.png").into(holder.imageView);

...
public class MyHorAdapter extends RecyclerView.Adapter<MyHorAdapter.LinearViewHolder> {
    ...
    public MyHorAdapter(Context context, OnItemClickListener listener) {
    ...
    public MyHorAdapter.LinearViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LinearViewHolder(LayoutInflater.from(mContext).inflate(R.layout.activity_hor_rv_item, parent, false));
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyHorAdapter.LinearViewHolder holder, int position) {

        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_toast_2:
                    ...
                    toastCenter.setGravity(Gravity.CENTER, 0, 0); // setGravity高版本API不再适用
                    toastCenter.show();
                    break;
                ...
                case R.id.btn_toast_3:
                    ...
                    ImageView imgView = view.findViewById(R.id.iv_toast);
                    TextView textView = view.findViewById(R.id.tv_toast);
                    imgView.setImageResource(R.drawable.wanchengchenggong);
                ...
                case R.id.btn_toast_4:
                    ToastUtil.showMessage(getApplicationContext(), "封装的Toast");
